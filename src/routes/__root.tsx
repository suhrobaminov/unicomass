...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "youradviser — AI College Admissions Strategy" },
      ...
      { property: "og:title", content: "youradviser — AI College Admissions Strategy" },
      { property: "og:description", content: "Personalized college lists, profile scores, and next steps powered by AI." },
